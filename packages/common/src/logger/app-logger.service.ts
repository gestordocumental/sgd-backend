...
// Resolved once at startup. Each service sets SERVICE_NAME in its environment.
const SERVICE_NAME =
...
export class AppLogger implements LoggerService {
  ...
  /** Used by interceptors/filters to log structured HTTP and Kafka events. */
  ...
  /** Production: structured JSON — parseable by Elasticsearch / Railway logs. */
  private prodFormat() {
    return format.combine(
      format.timestamp(),
